...
const SCHOLARSHIPS = [
  { icon: <HiOutlineStar className="h-6 w-6" />, title: "Merit Scholarship", amount: "Up to 100%", description: "For students in the top 1% of qualifying exams — full tuition covered.", tone: "from-sky/20 to-transparent" },
  { icon: <HiOutlineHeart className="h-6 w-6" />, title: "Need-based Grant", amount: "Up to 60%", description: "Financial assistance based on annual family income and academic potential.", tone: "from-emerald-400/20 to-transparent" },
  { icon: <HiOutlineGlobeAlt className="h-6 w-6" />, title: "Diversity Programme", amount: "Up to 40%", description: "Support for underrepresented regions, first-generation and international students.", tone: "from-fuchsia-400/20 to-transparent" },
];
