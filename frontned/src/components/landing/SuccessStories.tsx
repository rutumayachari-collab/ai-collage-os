...
const STORIES = [
  {
    photo: alum1, name: "Ananya Kapoor", role: "Product Manager · Google",
    year: "MBA · 2023", metric: "42 LPA",
    quote: "The analytics track combined with real client projects made me interview-ready. My PM offer came before I graduated.",
  },
  {
    photo: alum2, name: "Rahul Verma", role: "SDE-2 · Amazon",
    year: "B.Tech CSE · 2022", metric: "38 LPA",
    quote: "AI-CollegeOS matched me to research and internships that shaped my career. The placement cell felt like a coach, not a queue.",
  },
  {
    photo: alum3, name: "Neha Krishnan", role: "Research Scientist · Adobe",
    year: "B.Tech CSE · 2024", metric: "44 LPA",
    quote: "Faculty mentorship on my ML thesis got me a top-tier research role straight out of undergrad. Life-changing.",
  },
];
            ...
            >
              ...
              <div className="mt-6 flex items-center justify-between border-t border-border pt-4">
                ...
                <button className="inline-flex items-center gap-1 text-sm font-medium text-navy hover:text-sky">
                  Read story <HiArrowRight className="h-4 w-4 transition-transform group-hover:translate-x-1" />
                </button>
              </div>
            </motion.article>
          ))}
