...
const FEATURES = [
  {
    ...
    description:
      "A 24/7 conversational agent that answers queries, recommends programmes and pre-fills applications.",
  },
  {
    icon: <HiOutlineLightningBolt className="h-6 w-6" />,
    title: "Fast Admission Process",
    description:
      "From inquiry to confirmation in under 72 hours with automated document verification.",
  },
  {
    icon: <HiOutlineAcademicCap className="h-6 w-6" />,
    title: "Experienced Faculty",
    description: "Learn from PhDs and industry leaders shaping tomorrow's research and practice.",
  },
  {
    icon: <HiOutlineBriefcase className="h-6 w-6" />,
    title: "Excellent Placements",
    description:
      "500+ recruiter partners with a 96% placement rate across engineering and management.",
  },
  {
    icon: <HiOutlineGift className="h-6 w-6" />,
    title: "Scholarships",
    description:
      "Merit, need-based and diversity scholarships automatically matched to your profile.",
  },
  {
    icon: <HiOutlineOfficeBuilding className="h-6 w-6" />,
    title: "Modern Campus",
    description:
      "Smart classrooms, research labs, sports arenas and residential hostels — all connected.",
  },
];
