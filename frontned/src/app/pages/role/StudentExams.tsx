...
export function StudentExams() {
  ...
  if (error) {
    toast.error("Failed to load exams profile");
  }
      ...
      {isLoading ? (
        ...
        <Card>
          <CardContent className="flex flex-col items-center justify-center py-12 text-center">
            ...
            <p className="text-sm font-medium">Failed to load exams</p>
        ...
        <Card>
          <CardContent className="flex flex-col items-center justify-center py-12 text-center">
            ...
            <p className="text-xs text-muted-foreground mt-1">
              Exam data requires implementation of{" "}
              <code className="rounded bg-muted px-1 py-0.5 text-xs">GET /students/me/exams</code>.
            </p>
          </CardContent>
        </Card>
      )}
