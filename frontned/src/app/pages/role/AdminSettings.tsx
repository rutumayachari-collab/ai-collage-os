        ...
        <TabsContent value="departments">
          <Card>
            ...
            <CardContent>
              ...
              <Button onClick={() => window.location.assign("/admin/departments")}>
                Manage Departments
              </Button>
            </CardContent>
          </Card>
        ...
        <TabsContent value="courses">
          <Card>
            ...
            <CardContent>
              ...
              <Button onClick={() => window.location.assign("/admin/courses")}>
                Manage Courses
              </Button>
            </CardContent>
          </Card>
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              ...
              <div className="flex items-center justify-between">
                ...
                <Switch
                  checked={settings?.notifications?.whatsapp ?? true}
                  onCheckedChange={(checked) =>
