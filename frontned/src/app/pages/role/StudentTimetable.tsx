...
export function StudentTimetable() {
  ...
  if (error) {
    toast.error("Failed to load timetable profile");
  }
      ...
      {isLoading ? (
        ...
        <Card>
          <CardContent className="flex flex-col items-center justify-center py-12 text-center">
            ...
            <p className="text-sm font-medium">Failed to load timetable</p>
        ...
        <Card>
          <CardContent className="flex flex-col items-center justify-center py-12 text-center">
            ...
            <p className="text-sm font-medium">No timetable available</p>
            <p className="text-xs text-muted-foreground mt-1">
              Timetable data requires implementation of{" "}
