...
export function StudentCourses() {
  ...
  if (error) {
    toast.error("Failed to load courses profile");
  }
        ...
        <Card>
          <CardContent className="flex flex-col items-center justify-center py-12 text-center">
            ...
            <p className="text-xs text-muted-foreground mt-1">
              Course enrollment data requires implementation of{" "}
              <code className="rounded bg-muted px-1 py-0.5 text-xs">GET /students/me/courses</code>
              .
            </p>
          </CardContent>
        </Card>
