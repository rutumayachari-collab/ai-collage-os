...
export function StudentScholarships() {
  ...
  return (
    <div className="space-y-6">
      <PageHeader
        title="Scholarships"
        description="View your scholarships and financial aid"
        actions={
      ...
      {isLoading ? (
        ...
        <Card>
          <CardContent className="flex flex-col items-center justify-center py-12 text-center">
            ...
            <p className="text-sm font-medium">Failed to load scholarships</p>
        ...
        <Card>
          <CardContent className="flex flex-col items-center justify-center py-12 text-center">
            ...
            <p className="text-xs text-muted-foreground mt-1">
              Scholarship data requires implementation of{" "}
              <code className="rounded bg-muted px-1 py-0.5 text-xs">
                GET /students/me/scholarships
              </code>
              .
            </p>
          </CardContent>
